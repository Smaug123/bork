...
* an optional [code database file](./code-database.md) to read from and write to (although neither reading nor writing from within the harness is currently implemented).
