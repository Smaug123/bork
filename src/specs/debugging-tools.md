...
* prints to stderr the requests to and responses from the LLM in the [edit loop](./edit-loop.md), including debug-logging individual messages streamed in any streaming response.
